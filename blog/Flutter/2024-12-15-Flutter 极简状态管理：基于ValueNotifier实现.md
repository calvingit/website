...
在 Flutter 开发中，状态管理方案的选择往往让开发者感到困惑。从 Stacked、Provider、Bloc 到全能的 GetX，从 web 端过来的 Redux、Mobx、Signal，再到最近很火的 Provider的亲兄弟Riverpod，各种方案都有其独特的优势和适用场景，但每一种都有一些地方让我难以理解或认同，要么规定了很多骚操作，要么模板代码太多，要么背后隐藏着太多 “魔法”，而我需要的是简单易懂、尽可能简洁、可扩展的方案。
