---
title: 减轻 AppDelegate 的负担
description: "AppDelegate 应该是承载任务最多的地方了，冷启动、通知、各种初始化操作都在这里汇聚，当你的 AppDelegate 上千行时，就很有必要对其进行解构了，本文介绍三种方法：命令模式，组合模式，中介者模式。"
slug: ios-appdelegate
date: 2019-08-24
tags: [iOS]
---
